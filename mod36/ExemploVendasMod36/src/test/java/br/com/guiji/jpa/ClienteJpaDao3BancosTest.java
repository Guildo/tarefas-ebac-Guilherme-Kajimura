...
import br.com.guiji.dao.jpa.ClienteJpaDB2DAO;
import br.com.guiji.dao.jpa.ClienteJpaDB3DAO;
import br.com.guiji.dao.jpa.IClienteJpaDAO;
import br.com.guiji.domain.jpa.ClienteJpa;
import br.com.guiji.domain.jpa.ClienteJpa2;
...
public class ClienteJpaDao3BancosTest {
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		clienteConsultado.setNome("Guilherme Kajimura ");
		clienteDao.alterar(clienteConsultado);
		
		ClienteJpa clienteAlterado = clienteDao.consultar(clienteConsultado.getId());
		Assert.assertNotNull(clienteAlterado);
		Assert.assertEquals("Guilherme Kajimura ", clienteAlterado.getNome());

...
public class MongoConfig {
    ...
    public MongoClient mongo() throws Exception {
		...
		final ConnectionString connectionString = new ConnectionString("mongodb://admin:admin@127.0.0.1:27017/ebac?&readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false");

...
package br.com.guiji.vendas.online;
...
import br.com.guiji.vendas.online.domain.Cliente;
import br.com.guiji.vendas.online.reources.ClienteResource;
import br.com.guiji.vendas.online.usecase.BuscaCliente;
import br.com.guiji.vendas.online.usecase.CadastroCliente;
...
public class ClienteResourceTest {
	...
	public void buscarPorId() {
		Cliente cliente1 = Cliente.builder().id("1").nome("guilherme 1").build();
